...
2. **Aspect-based Sentiment Analysis**: Utilizing a BERT-based sentiment analysis model, the project analyzed both submissions and comments to gauge public sentiment surrounding various aspects of CBD, such as its effectiveness, side effects, dosage, and administration methods.
